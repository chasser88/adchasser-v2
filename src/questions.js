// ── AdChasser Survey Questions ──────────────────────────────────
// Two questionnaire tracks: GOODS and SERVICES
// Routed based on brand.brand_type
...
export const QUESTIONS = {
  ...
  2: [
    {
      id: 'q2_1', type: 'open',
      text: "Thinking about [CATEGORY] advertising you've come across recently — on any screen, surface or channel — what's the first thing that comes to mind?",
    ...
    {
      id: 'q2_4', type: 'multi',
      text: "Where did you come across it? Pick everything that applies.",
      options: [
    ...
    {
      id: 'q2_7', type: 'single',
      text: "Where were you, roughly, when you came across it most?",
      options: [
  ...
  3: [
    ...
    },
    {
      ...
      text: "How sharp did the message feel to you — did you immediately get what they were trying to say?",
  ...
  4: [
    {
      ...
      text: "Close your eyes for a second — or just pause. When you bring that campaign to mind, what's the first feeling that surfaces? Pick up to 3.",
      clusters: [
  ...
  5: [
    ...
    {
      id: 'q5_3', type: 'open',
      text: "What makes [BRAND] feel different — if anything — from the others in this space?",
    ...
    {
      id: 'q5_7', type: 'scale', min: 0, max: 10,
      text: "How likely are you to recommend [BRAND] to a friend or family member?",
  ...
  6: [
    ...
    {
      id: 'q6_2', type: 'single',
      text: "Did the campaign push you to do anything — even something small?",
      options: [
    ...
    {
      id: 'q6_4', type: 'multi',
      text: "If the campaign didn't lead to a purchase — what would have needed to be different?",
      options: [
  ...
  7: [
    {
      id: 'q7_1', type: 'open',
      text: "What was the thing about this campaign — if anything — that genuinely worked for you?",
...
export const QUESTIONS_SERVICES = {
  1: [
    {
      id: 'q1_1', type: 'single',
      text: "When you think about [CATEGORY] — whether it's something you use regularly or only when you need to — how would you describe yourself as a customer in this space?",
      options: [
        "I know exactly who I use and I'm not looking to change",
        "I'm open to switching if something better comes along",
        "I go with what people I trust recommend",
        "I use whoever is most convenient or competitive at the time",
        "I don't think about it much — I'm just with whoever I'm with",
      ],
    },
    {
      id: 'q1_2', type: 'single',
      text: "How actively do you engage with [CATEGORY] services right now?",
      options: [
        "Daily or near-daily — it's part of how I operate",
        "Weekly — I interact with it regularly but not constantly",
        "Monthly — I dip in when I need something",
        "Occasionally — only when something comes up",
        "Rarely — I'm technically a customer but barely engage",
      ],
    },
    {
      id: 'q1_3', type: 'single',
      text: "If you had to describe your relationship with [BRAND] the way you'd describe a person — which comes closest?",
      options: [
        "A trusted advisor — I rely on them and they've never let me down",
        "A reliable colleague — professional, does the job, nothing more",
        "An acquaintance — I know of them but we're not close",
        "Someone I've drifted from — we used to have more of a relationship",
        "A stranger — I know the name but haven't really experienced them",
        "A competitor's loyalist — I'm with someone else, honestly",
      ],
    },
    {
    ...
    {
      id: 'q1_5', type: 'single',
      text: "Just so we can group your answers with people in a similar situation — roughly where are you in life right now?",
      options: [
        "Early career, living independently or with others",
        "Building — career growing, maybe a family starting",
        "Established — settled, responsibilities are real",
    ...
    {
      id: 'q1_6', type: 'single',
      text: "When it comes to spending on [CATEGORY] services, which feels most like you?",
      options: [
        "I invest in quality — the right provider is worth paying for",
        "I want value — good service at a fair price",
        "I shop around — I compare and I switch if something's better",
        "Price is the main factor — I go with whoever is most competitive",
        "I'm locked in by contract or habit — it's not really my decision right now",
      ],
    },
  ],
  2: [
    {
      id: 'q2_1', type: 'open',
      text: "Thinking about advertising for [CATEGORY] services you've come across recently — on any channel — what's the first thing that comes to mind?",
      placeholder: "Just say whatever surfaces first — no wrong answers here...",
    },
    {
      id: 'q2_2', type: 'single', isGate: true,
      text: "Has anything from [BRAND] specifically crossed your path lately — an ad, a campaign, a promotion, a post? Don't overthink it.",
      options: [
        "Yes, definitely — something's been showing up",
        "I think so — something feels familiar but I'm not certain",
        "Not that I've noticed",
    ...
    },
    {
      ...
      options: [
        ...
        "A website or app I was using",
        "Radio or a podcast",
        "In a branch, office or physical location",
        "Somewhere else entirely",
      ],
    },
    {
    ...
    {
      id: 'q2_6', type: 'single',
      text: "Did you do anything with it — even something small? Pause, look them up, visit their website, ask someone about them?",
      options: [
        "Yes — I actively looked into it or reached out",
        "Not deliberately, but it made me stop for a second",
        "No — it registered but I kept moving",
        "No — I actively ignored or skipped it",
      ],
  ...
  3: [
    ...
    {
      id: 'q3_3', type: 'scale', min: 1, max: 10,
      text: "How sharp did the message feel — did you immediately understand what they were offering or promising?",
      minLabel: "No idea what they were going for",
      maxLabel: "Crystal clear — got it immediately",
    },
    {
      id: 'q3_4', type: 'single',
      text: "Did what they were saying feel like it was aimed at someone in your situation?",
      options: [
        "Yes — it spoke directly to my circumstances",
        "Somewhat — parts of it felt relevant to me",
        "Not really — it felt aimed at a different type of customer",
        "No — this clearly wasn't made with someone like me in mind",
      ],
    },
    {
      id: 'q3_5', type: 'yes_no_open',
  ...
  4: [
    ...
    {
      id: 'q4_3', type: 'single',
      text: "How much did the campaign feel like it came from [BRAND] — like you could have guessed who it was without being told?",
      options: [
        "Completely — it felt distinctly them",
        "Mostly — it fits, even if it wasn't instantly obvious",
        "Somewhat — it could have been several brands in this space",
        "Not really — it felt disconnected from what I know of them",
        "I don't know the brand well enough to say",
      ],
    },
    {
      id: 'q4_4', type: 'single',
      text: "Did seeing this campaign change anything about how you think or feel about [BRAND]?",
      options: [
        "Yes — they've gone up in my estimation",
        "Slightly — it nudged something, but nothing dramatic",
        "No — same as before, neither better nor worse",
        "Actually, it pulled them back a little for me",
        "I didn't have a strong view before, but now I'm forming one",
      ],
    },
    {
      id: 'q4_5', type: 'single',
  ...
  5: [
    {
      id: 'q5_1', type: 'single',
      text: "If someone asked you to name a [CATEGORY] provider right now, unprompted — where does [BRAND] naturally sit in your head?",
      options: [
        "First one I'd mention, without thinking",
        "One of a short list that comes to mind",
        "It comes to mind, but not immediately",
    ...
    {
      id: 'q5_2', type: 'scale', min: 1, max: 10,
      text: "How much does [BRAND] feel genuinely relevant to your life — not just as a service, but as a provider that fits who you are or what you value?",
      minLabel: "Doesn't connect with my life at all",
      maxLabel: "Feels made for someone like me",
    },
    {
      id: 'q5_3', type: 'open',
      text: "What makes [BRAND] feel different — if anything — from other providers in this space?",
      placeholder: "Take a moment — what comes to mind?",
    },
    {
      id: 'q5_4', type: 'single',
    ...
    {
      id: 'q5_5', type: 'single',
      text: "If a friend asked you about [BRAND], what would you most likely say?",
      options: [
        "I'd recommend them without hesitation",
        "I'd say positive things but probably not push them strongly",
        "I'd be neutral — neither sell them nor dismiss them",
        "I'd mention some reservations worth knowing about",
        "I'd actively steer them elsewhere, if I'm honest",
      ],
    },
    {
      id: 'q5_6', type: 'scale', min: 1, max: 10,
      text: "All things considered — how powerful does [BRAND] feel to you as a brand right now?",
      minLabel: "Weak — barely registers",
      maxLabel: "Dominant — a brand that really stands for something",
    },
    {
      id: 'q5_7', type: 'scale', min: 0, max: 10,
      text: "How likely are you to recommend [BRAND] to a friend or colleague who needs this type of service?",
      minLabel: "Not at all likely",
      maxLabel: "Extremely likely",
      isNPS: true,
    },
  ...
  6: [
    {
      id: 'q6_1', type: 'single',
      text: "After seeing this campaign, where did [BRAND] sit in your mind when you next thought about this type of service?",
      options: [
        "It moved to the top of my consideration list",
        "It was already there, and this reinforced it",
        "It got added to my thinking — I wouldn't have considered them before",
        "It was already on my radar but this didn't really move it",
        "It didn't factor into my thinking at all",
      ],
    },
    {
      id: 'q6_2', type: 'single',
      text: "Did the campaign push you to do anything — even something small? Look them up, visit their website, call, ask someone about them?",
      options: [
        "Yes — I actively looked into them or made contact",
        "I thought about it but didn't follow through",
        "Not consciously, but I may have paid more attention to them since",
        "No — it didn't trigger any action",
      ],
    },
    {
      id: 'q6_3', type: 'single',
      text: "Did you sign up, subscribe, enquire or engage with [BRAND] — or increase your engagement — around the time of this campaign?",
      options: [
        "Yes — I took action and I think the campaign played a role",
        "Yes — but I was already planning to",
        "No — but I'm more likely to consider them next time I need this",
        "No — and my likelihood hasn't really changed",
        "No — and if anything I'm less inclined now",
      ],
    },
    {
      id: 'q6_4', type: 'multi',
      text: "If the campaign didn't lead to any action — what would have needed to be different?",
      options: [
        "A clearer reason to choose them over who I currently use",
        "More proof that they deliver on their promises",
        "A better offer, trial or introductory deal",
        "More transparency about pricing or what's included",
        "Seeing people like me who've had a good experience with them",
        "The timing just wasn't right — I'm not in the market right now",
        "Nothing — I'm just not the right customer for this service",
      ],
    },
  ],
  7: [
    ...
    {
      id: 'q7_2', type: 'multi',
      text: "Which of these, if any, were real strengths of this campaign?",
      options: [
        "The visual quality — it was well made and looked credible",
        "The message — it said something worth saying",
        "The proof — it showed real outcomes or real customer experiences",
        "The emotion — it touched something genuine",
        "The relevance — it felt like it understood my situation",
        "The clarity — I knew exactly what they were offering",
        "The trust signals — it made the brand feel reliable and legitimate",
      ],
    },
    {
      id: 'q7_3', type: 'open',
    ...
    {
      id: 'q7_4', type: 'rank',
      text: "What would make the biggest difference to how you engage with [BRAND]'s advertising? Tap in order of importance.",
      options: [
        "Show me real customers and their genuine experiences",
        "Give me clearer information about what I actually get",
        "Less frequency — I've seen this too many times",
        "Meet me on the channels I actually use",
        "Make the message sharper — tell me why it matters to me",
        "Build more trust — show me why I should believe you",
        "Make it shorter and more direct — respect my time",
      ],
    },
    {
      id: 'q7_5', type: 'single',
      text: "If [BRAND] could show you one thing that would genuinely make you stop and pay attention, what would it be?",
      options: [
        "A real customer story — authentic, not polished",
        "Proof of results — show me the outcomes, not the promise",
        "Humour — make me genuinely laugh",
        "A clear, honest comparison — show me why they're better",
        "Values — show me what the company actually stands for",
        "An offer or incentive that feels genuinely worthwhile",
        "Education — teach me something relevant to my situation",
      ],
    },
    {
      id: 'q7_6', type: 'open',
...
// ── Get questionnaire based on brand type ───────────────────────
export function getQuestionnaire(brandType) {
  if (brandType === 'services') return QUESTIONS_SERVICES
  return QUESTIONS // goods or mixed defaults to goods questionnaire
}
