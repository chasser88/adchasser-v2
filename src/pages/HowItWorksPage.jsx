...
const STEPS = [
  ...
  { n: '05', title: 'Receive diagnostic intelligence', body: 'The gap between Track A and Track B responses reveals whether underperformance is a reach problem or a creative problem — with specific recommended actions for each.' },
  ...
  return (
    <div style={{ background: C.bg, color: C.text, fontFamily: F.sans, minHeight: '100vh' }}>
      ...
      <section style={{ padding: 'clamp(48px,8vw,96px) 5%', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: 'clamp(14px,2vw,17px)', color: C.muted, lineHeight: 1.8, maxWidth: '560px', margin: '0 auto' }}>
          AdChasser combines survey methodology, real-time analytics, and diagnostic intelligence into a single workflow.
        </p>
      </section>
      ...
      <section style={{ padding: 'clamp(48px,8vw,80px) 5%', background: C.surface, textAlign: 'center' }}>
        <h2 style={{ fontSize: 'clamp(22px,3vw,36px)', fontFamily: F.display, fontWeight: 700, marginBottom: '14px' }}>Ready to try it on your campaign?</h2>
        <p style={{ fontSize: '15px', color: C.muted, marginBottom: '28px' }}>Free to start. No credit card required.</p>
